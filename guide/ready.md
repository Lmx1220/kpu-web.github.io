...
阅读开发文档前，请确保手上已经有 kpu-web 源码，因为文档中提及的内容，都是需要在本地项目中编写或修改代码并运行才能呈现的。


### 基础版

到 [Github Releases](https://github.com/Lmx1220/vue3-ts/releases) 页面下载最新版本的压缩包，如下图所示：

![](/download.png){data-zoomable}

或者也可以从 Github 上拉取源码，但需要注意，直接拉取源码可能会包含未发布的内容，最终发布时可能会有变动，请谨慎使用。

::: code-group

```sh [从 Github 拉取]
# 拉取框架源码
git clone https://github.com/Lmx1220/vue3-ts.git
# 拉取演示源码
git clone -b example https://github.com/Lmx1220/vue3-ts.git
```
...
::: warning 注意
在 [package.json](https://github.com/Lmx1220/vue3-ts/blob/example/package.json#L6-L8) 文件中有限制 node 要求版本，建议使用最新 LTS 版本。
:::
