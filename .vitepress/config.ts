...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { name: 'keywords', content: 'kpu-web,后台系统,管理后台,后台模版,vue后台,vue-admin,vue-element-admin,vue-admin-template' }],
    ['keywords', { content: 'kpu-web,后台系统,管理后台,后台模版,vue后台,vue-admin,vue-element-admin,vue-admin-template' }],
...
(function(c,l,a,r,i,t,y){
  ...
  themeConfig: {
    logo: '/logo.png',
    footer: {
      copyright: 'Copyright © 2020-present kpu-web',
    },
    nav: [
      {
        text: '文档',
      ...
      //         // {
      //         //   text: '专业版',
      //         //   link: 'https://kpu-web.pages.dev/pro-example',
      //         // },
      //       ],
      //     },
      //   ],
      ...
      },
      {
        ...
        items: [
          {
            text: '下载基础版',
            link: 'https://github.com/Lmx1220/vue3-ts/releases',
          },
          {
            text: '定制开发',
            link: '/customize',
    ...
    socialLinks: [
      {
        ...
        link: 'https://gitee.com/kpu-web/basic',
      },
      {
        icon: 'github',
        link: 'https://github.com/kpu-web/basic',
      },
    ],
    sidebar: {
      '/guide/': [
